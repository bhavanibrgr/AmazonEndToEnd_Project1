...
public class TC5_VerifyingProductDetailPage extends BaseClass{
	...
	public void verifyProductDetails(String username, String password, String comments) throws InterruptedException {
		...
		sa.assertTrue(addToCartButton.isDisplayed(), "Assertion failed as the add to cart button not displayed");
		sa.assertAll();
	}
}
